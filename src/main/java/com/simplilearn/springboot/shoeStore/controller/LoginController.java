...
import com.simplilearn.springboot.shoeStore.repository.RoleRepository;
...
public class LoginController {
	...
	public String registerPost(@ModelAttribute("user")User user, HttpServletRequest request) throws SerialException, ServletException{
